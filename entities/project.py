...
def bias_function_factory(P,percent_male_at_above_level, type,turn):
    ...
    if type == 'success':
        return partial(project_promotability,
...
def project_promotability(proj,pure_gender_bias,mix_group_bias,complaint_percentage,complaint_bias):
